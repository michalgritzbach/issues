defmodule Issues.TableFormatter do
  ...
  @doc """
  Takes a list of row data, where each row is a Map, and list of
  ...
  @doc """
  Given a list containig sublists, where each sublist contains data for
  ...
  hyphens, with + signs where the vertical bar between columns goes.
